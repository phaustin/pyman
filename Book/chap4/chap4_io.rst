...
Sometimes you have data stored in a spreadsheet program like Excel that you would like to read into a Python program.  The :ref:`fig-ExcelWindow` shown here contains the same data set we saw above in a text file.

.. _fig-ExcelWindow:

.. figure:: ExcelDataFile.png
   :scale: 65 %
   :align: center
