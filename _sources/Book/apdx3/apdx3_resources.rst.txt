...
The best web resource for Python is a good search engine like Google.  Nevertheless, I list a few web sites here that you might find useful.  I have successfully resisted any attempt to be exhaustive so that the list is actually useful.  Nevertheless, if you find a really cool site that you think should be on this list, please let me know.
    ...
    http://docs.python.org/3/reference/
        Sometimes I look here for detailed information about Python 3, which is the version used in this manual.  Documentation for the previous version, Python 2,
        is available at http://docs.python.org/2/reference/
    ...
    http://docs.continuum.io/anaconda/index is the location for documentation for Anaconda python
    ...
    https://pythonhosted.org/spyder/index.html
       ...
       Doucumentation for  Spyder, the Integrated Development Environment provided with with Anaconda. 
